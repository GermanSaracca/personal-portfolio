...
const Header = () => {
    ...
    return (
        <header className="fixed flex items-center w-full px-4 text-gray-800 bg-gray-300 shadow-lg sm:px-12 h-14 dark:bg-gray-800 dark:text-gray-200 xl:static xl:flex-col xl:h-screen xl:p-0">
